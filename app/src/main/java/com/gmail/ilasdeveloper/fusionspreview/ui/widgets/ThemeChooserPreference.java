...
public class ThemeChooserPreference extends Preference {
    ...
    public void onBindViewHolder(@NonNull PreferenceViewHolder holder) {
        ...
        HorizontalScrollView scrollView = (HorizontalScrollView) holder.findViewById(R.id.scrollView);
        ...
        for (AppTheme theme : entries) {
            ...
            ItemColorSchemeBinding item = ItemColorSchemeBinding.inflate(LayoutInflater.from(context), layout, false);
    ...
    protected void onSetInitialValue(@Nullable Object defaultValue) {
        String value = getPersistedString(defaultValue instanceof String ? defaultValue.toString() : AppTheme.DEFAULT.name());
