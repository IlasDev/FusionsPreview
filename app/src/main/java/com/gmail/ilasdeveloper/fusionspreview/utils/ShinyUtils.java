...
public class ShinyUtils {
    ...
    public static int calcShinyHue(int num1, int num2, boolean hasShinyHead, boolean hasShinyBody) {
        ...
        if (hasShinyHead
                && hasShinyBody
                && shinyColorOffsetsDict.containsKey(num1)
                && shinyColorOffsetsDict.containsKey(num2)) {
    ...
    public static int calcShinyHueDefault(
            int num1, int num2, boolean hasShinyHead, boolean hasShinyBody) {
